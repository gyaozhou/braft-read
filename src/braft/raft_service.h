...
// zhou: RPC Server side, just an adpater, will invoke class NodeImpl.
//
//       RPC interface defined in raft.proto, generated by protobuf, used by brpc.
//       class RaftServiceImpl object should register to a RPC Server framework,
//       e.g. gRPC, bRpc
